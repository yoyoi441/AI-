...
public enum L {
    private static let table: [String: (ja: String, en: String)] = [
        ...
        "displayItemsFooterMac": ("Claude CodeとCodex両方に共通の設定です。ウィジェットは表示スペースが限られているため、この設定の対象はメニューバーのドロップダウンのみです。", "Applies to both Claude Code and Codex. Widgets have limited space, so this setting only affects the menu bar dropdown."),
